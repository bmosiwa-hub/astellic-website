...
export const metadata: Metadata = {
  title: "Advisory Work",
  description:
    "Astellic's policy advisory, technical assistance, and strategic support engagements across Africa.",
};
      ...
      <section className="relative bg-brand-navy text-white py-24 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <p className="text-gray-300 text-xl max-w-2xl leading-relaxed">
            Policy advisory, technical assistance, and strategic support to
            governments, donors, and institutions navigating complex development
            challenges.
          </p>
        </div>
      </section>
        ...
        {projects.length === 0 ? (
          <div className="border border-dashed border-gray-200 rounded-xl py-16 text-center">
            <p className="text-brand-muted text-lg">
              Advisory project profiles are being compiled. Check back soon.
            </p>
          </div>
        ) : (
