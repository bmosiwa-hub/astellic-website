  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          { label: "Record Income", href: "/finance/income/new" },
          { label: "Record Expense", href: "/finance/expenses/new" },
          { label: "Add Project", href: "/finance/projects/new" },
          { label: "Run Payroll", href: "/finance/payroll/new" },
        ].map((a) => (
          <Link
            key={a.href}
            href={a.href}
