...
export const metadata: Metadata = {
  ...
  description:
    "Astellic's Policy Development & Advisory pillar â€” translating evidence into policies, strategies, and systems that are technically credible, politically feasible, and institutionally deliverable.",
};
...
const subUnits = [
  ...
  },
  {
    ...
    desc: "In the development sector, the gap between what is known and what is decided is often a communications failure, not an evidence failure. This sub-unit converts technical outputs into policy narratives, visual communications, and engagement strategies that shift understanding at the decision-maker level. We also generate Astellic's flagship thought leadership products â€” positioning the firm as a trusted intellectual voice in African development.",
    services: [
    ...
    <>
      ...
      <section className="bg-brand-light py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <FadeUp>
            <h2 className="text-3xl font-bold text-brand-navy mb-8 text-center">Policy Pillar â€” Full Service Range</h2>
          </FadeUp>
      ...
      <section className="py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <FadeUp>
            <h2 className="text-xl font-bold text-brand-navy mb-3">Policy advisory works because of evidence â€” and for implementation.</h2>
            <p className="text-brand-muted mb-8">
              Our policy work is grounded in rigorous evidence from Pillar 01 and designed to be
              implementable through Pillar 03 â€” ensuring the full results chain holds together.
            </p>
          </FadeUp>
          <FadeUp delay={100}>
