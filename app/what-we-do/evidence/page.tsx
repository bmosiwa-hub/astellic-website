...
const subUnits = [
  ...
  },
  {
    ...
    tagline: "Independent monitoring, verification, and evaluation: building the conditions for evidence that donors and governments can trust and act on.",
    desc: "Our MEAL sub-unit combines independent third-party monitoring and verification with rigorous evaluation, accountability mechanisms, and real-time learning. We go beyond compliance-driven monitoring to ensure the evidence programmes generate is analytically sound, methodologically rigorous, and decision-useful. Data quality and integrity are embedded throughout, not treated as afterthoughts.",
    services: [
      "Third-Party Monitoring (TPM)",
      "Independent Verification & Validation (IV&V)",
      "Adaptive Monitoring, Evaluation & Learning",
      "Real-time learning systems design and implementation",
