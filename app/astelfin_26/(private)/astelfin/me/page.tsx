...
export const metadata = { title: "M&E | Astelfin", robots: { index: false, follow: false } };

const DEPT_ALIASES = ["M&E", "Monitoring and Evaluation", "Research", "Evidence", "MEL"];

const QUICK_ACTIONS = [
  { label: "ASIL — Pilot Lab",   desc: "Social impact pilots and experiments",   href: "/astelfin_26/asil",            icon: "🧪" },
  { label: "Pilot Registry",     desc: "Active and completed pilot profiles",     href: "/astelfin_26/asil/pilots",     icon: "📋" },
  { label: "Knowledge Library",  desc: "Learning reports and intelligence briefs",href: "/astelfin_26/asil/library",    icon: "📚" },
  { label: "Projects",           desc: "M&E project portfolio",                   href: "/astelfin_26/projects",        icon: "📁" },
  { label: "Deliverables",       desc: "Reports and milestone deliverables",      href: "/astelfin_26/deliverables",    icon: "✅" },
  { label: "Reports",            desc: "Financial and operational reports",       href: "/astelfin_26/reports",         icon: "📑" },
];
...
export default async function MandEDeptPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10">
      <div className="space-y-1">
        ...
        <h1 className="text-3xl font-bold text-brand-navy">M&amp;E Services</h1>
        <p className="text-brand-muted text-sm">Monitoring, evaluation, research and learning services for Astelfin and its clients.</p>
      ...
      {org && (
        <section className="space-y-6">
          <h2 className="text-xs font-bold uppercase tracking-widest text-brand-muted">M&amp;E Team</h2>
          {staff.length === 0 ? (
            <div className="bg-white rounded-2xl border-2 border-dashed border-gray-200 p-12 text-center">
              <p className="text-2xl mb-2">🧪</p>
              <p className="font-semibold text-brand-navy">No M&amp;E staff yet</p>
              <p className="text-sm text-brand-muted mt-1">Add employees with the <strong>M&amp;E</strong> department tag.</p>
      ...
      <section className="space-y-4">
        <h2 className="text-xs font-bold uppercase tracking-widest text-brand-muted">M&amp;E Operations</h2>
