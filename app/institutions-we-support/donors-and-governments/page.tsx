...
const services = [
  {
    ...
    description:
      "We design and conduct rigorous evaluations â€” formative, process, summative, and impact â€” that give funders and governments credible evidence on what their investments are achieving. Our evaluations are built for use, not just reporting.",
    icon: (
  ...
  },
  {
    ...
    description:
      "We work with national and subnational governments to strengthen budget systems, expenditure tracking, and accountability frameworks â€” ensuring public resources reach intended beneficiaries and deliver value for money.",
    icon: (
      <svg className="w-6 h-6 text-brand-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    description:
      "We help bilateral and multilateral donors assess the effectiveness of their portfolios â€” identifying patterns of success and failure across programmes, countries, and sectors to sharpen future investment decisions.",
    icon: (
      <svg className="w-6 h-6 text-brand-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    description:
      "We support governments to build sustainable national data systems â€” from routine health information to civil registration, agricultural surveys, and social protection registers â€” that produce timely, reliable data for decision-making.",
    icon: (
      <svg className="w-6 h-6 text-brand-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
const approach = [
  {
    ...
    desc: "We begin by mapping the policy environment, institutional landscape, and political economy â€” not just the technical problem. Every recommendation accounts for what is feasible in context.",
  },
  {
    step: "02",
  ...
  },
  {
    ...
    desc: "We stay engaged through the implementation phase â€” providing technical backstopping, adaptive management support, and course-correction as realities on the ground emerge.",
  },
];
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-brand-muted text-lg leading-relaxed mb-5">
              Donors and governments invest substantial resources in development programming â€” but too
            ...
            <p className="text-brand-muted text-lg leading-relaxed">
              ...
              the systems that make adaptive management possible â€” not as a one-off engagement,
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <FadeUp delay={100}>
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              ...
              a data system, or a development agency seeking an evaluation partner â€” we would
