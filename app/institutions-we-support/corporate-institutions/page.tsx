    ...
    <>
      ...
      <section className="py-20 px-6 bg-brand-light">
        <div className="max-w-5xl mx-auto">
          <FadeUp>
            <p className="text-brand-gold text-base font-bold uppercase tracking-widest mb-5">The Problem</p>
      ...
      <section className="py-12 px-6 bg-brand-navy text-white">
        <div className="max-w-4xl mx-auto text-center">
          <FadeUp>
            <p className="text-brand-gold text-base font-bold uppercase tracking-widest mb-5">Astellic&apos;s Position</p>
          ...
          <div className="space-y-8">
            {services.map((svc, si) => (
              ...
              <div className={`bg-brand-light rounded-2xl border-l-4 ${svc.color} p-8 grid md:grid-cols-[1fr_280px] gap-8 items-start lift`}>
                ...
                <div>
                  <p className="text-base font-bold uppercase tracking-widest text-brand-muted mb-3">Example Engagements</p>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <SlideLeft>
          <div>
            <p className="text-brand-gold text-base font-bold uppercase tracking-widest mb-4">Why Astellic</p>
      ...
      <section className="bg-brand-navy text-white py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <FadeUp>
            <p className="text-brand-gold text-base font-bold uppercase tracking-widest mb-4">Start Here</p>
