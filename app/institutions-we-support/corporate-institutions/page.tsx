      ...
      <section id="services" className="py-20 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            {services.map((svc) => (
              <div key={svc.num} className={`bg-brand-light rounded-2xl border-l-4 ${svc.color} p-8 grid md:grid-cols-[1fr_280px] gap-8 items-start`}>
                <div>
      ...
      <section className="py-16 px-6 bg-brand-light">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {clientTypes.map((ct) => (
              <div key={ct.label} className="bg-white rounded-xl border border-gray-100 p-5">
