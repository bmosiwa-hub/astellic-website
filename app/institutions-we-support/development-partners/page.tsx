...
const services = [
  ...
  },
  {
    ...
    description:
      "We conduct independent and joint evaluations across the full results chain â€” from implementation fidelity and output delivery through to outcome and impact assessment. Our evaluations are designed to produce actionable learning, not just accountability documentation.",
    icon: (
      <svg className="w-6 h-6 text-brand-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    description:
      "We build the human and institutional capacity of partner organisations and government counterparts â€” through structured training, on-the-job coaching, systems design, and knowledge transfer. We design capacity development programmes that stick beyond the project lifecycle.",
    icon: (
      <svg className="w-6 h-6 text-brand-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
  ...
  },
  {
    ...
    description:
      "We provide embedded technical assistance to implementing partners and government counterparts â€” placing our specialists within teams to provide day-to-day support on programme delivery, data management, policy analysis, and institutional strengthening.",
    icon: (
      <svg className="w-6 h-6 text-brand-teal" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
const valueProps = [
  {
    ...
    desc: "We do not just evaluate programmes in isolation. We analyse how programmes fit within national systems, policy environments, and institutional landscapes â€” and we design interventions that strengthen those systems, not just individual projects.",
  },
  {
    number: "02",
    title: "We Build Adaptive Learning into Everything",
    desc: "Astellic's approach to M&E is rooted in adaptive management. We design systems that generate learning for course-correction during implementation â€” not just summative evidence for the final report.",
  },
  {
    number: "03",
    title: "We Are Honest About What the Evidence Shows",
    desc: "Our evaluations and reviews are independent and evidence-driven. We report what the data shows â€” including what is not working â€” because that is the only basis on which programmes can genuinely improve.",
  },
  {
    number: "04",
          ...
          <SlideLeft>
            <div>
              ...
              <p className="text-brand-muted text-lg leading-relaxed mb-5">
                ...
                and what was achieved is rarely about intent â€” it is almost always about the quality
              ...
              <p className="text-brand-muted text-lg leading-relaxed">
                ...
                support â€” helping partners design programmes that are more likely to work, monitor them
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <FadeUp delay={100}>
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              ...
              complex implementation â€” we are here to work alongside you.
            </p>
          </FadeUp>
          <FadeUp delay={200}>
