...
export const metadata: Metadata = {
  title: "Vacancies & Calls",
  description:
    "Current vacancy notices, expressions of interest, and calls for consultants from Astellic.",
};
    ...
    <>
      ...
      <section className="relative bg-brand-navy text-white py-24 px-6 overflow-hidden">
        <Image
          ...
          alt="Vacancies and calls at Astellic"
          fill
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <p className="text-gray-300 text-xl max-w-2xl leading-relaxed">
            Current vacancy notices, expressions of interest, and calls for
            consultants. Download any document below to view the full terms and
            requirements.
          </p>
        </div>
      </section>
        ...
        {documents.length === 0 ? (
          <div className="border border-dashed border-gray-200 rounded-xl py-16 text-center">
            <p className="text-brand-muted text-lg">
              No active calls at this time. Check back soon.
            </p>
          </div>
        ) : (
