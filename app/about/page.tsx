    ...
    <>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-l-4 border-brand-teal pl-6 space-y-6">
            <div>
              <h3 className="font-semibold mb-1">Not a scarcity of strategy</h3>
            ...
            <div>
              <h3 className="font-semibold mb-1">A failure to convert it into results</h3>
              <p className="text-brand-muted text-sm leading-relaxed">
            ...
            <div>
              <h3 className="font-semibold mb-1">The Astellic Premise</h3>
              <p className="text-brand-muted text-sm leading-relaxed">
