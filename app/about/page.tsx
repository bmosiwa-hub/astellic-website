    ...
    <>
      ...
      <section className="relative bg-brand-navy text-white py-28 px-6 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto">
          <p className="text-brand-gold text-xs font-bold uppercase tracking-[0.2em] mb-5 animate-fade-up">
            About Astellic
          </p>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-[1fr_auto] gap-14 items-start">
          <div>
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-5">
              <p className="text-xs font-bold uppercase tracking-widest text-brand-muted mb-4">What Astellic Is Not</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="border border-white/10 rounded-xl p-6">
                <p className="text-brand-gold text-xs font-bold uppercase tracking-widest mb-2">{g.label}</p>
          ...
          <div className="grid md:grid-cols-2 gap-14">
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <Link key={s.num} href={s.href} className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <div className="bg-brand-light rounded-xl p-5 border-l-4 border-brand-gold">
                <p className="text-xs font-bold uppercase tracking-widest text-brand-muted mb-2">Engagement Model</p>
