...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { url: "/thematic-areas/governance", priority: 0.7, changeFrequency: "monthly" },
    { url: "/thematic-areas/climate", priority: 0.7, changeFrequency: "monthly" },
    { url: "/thematic-areas/education", priority: 0.7, changeFrequency: "monthly" },
    { url: "/our-projects", priority: 0.8, changeFrequency: "monthly" },
    { url: "/our-projects/research", priority: 0.7, changeFrequency: "monthly" },
    { url: "/our-projects/advisory", priority: 0.7, changeFrequency: "monthly" },
    { url: "/our-projects/implementation", priority: 0.7, changeFrequency: "monthly" },
